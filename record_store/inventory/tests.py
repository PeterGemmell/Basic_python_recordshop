...
class AlbumTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.album1 = Album.objects.create(title = "Making Your Mind Up", year = 1989, stock_level = 10, artist = self.artist1)


    def test_artist_saved(self):  # assertGreater is a method asserting that artist is greater than 0, i.e we have 1.
